...
class _GetUserMediaSampleState extends State<GetUserMediaSample> {
  ...
  void _startRecording() async {
    ...
    if (Platform.isIOS) {
      logger.i('Recording is not available on iOS');
      return;
    }

    //(rostopira): request write storage permission
  ...
  void _toggleTorch() async {
    ...
    if (has) {
      ...
      logger.i('[TORCH] Current camera does not support torch mode');
    }
  }
