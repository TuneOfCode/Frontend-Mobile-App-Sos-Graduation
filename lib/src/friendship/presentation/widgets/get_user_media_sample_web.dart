 ...
 * getUserMedia sample
 */
class GetUserMediaSampleWeb extends StatefulWidget {
  static String tag = 'get_usermedia_sample';

  const GetUserMediaSampleWeb({super.key});

  @override
  State<GetUserMediaSampleWeb> createState() => _GetUserMediaSampleWebState();
}

class _GetUserMediaSampleWebState extends State<GetUserMediaSampleWeb> {
